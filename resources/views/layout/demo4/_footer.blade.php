...
<div class="footer py-4 d-flex flex-lg-column {{ theme()->printHtmlClasses('footer', false) }}" id="kt_footer">
	...
	<div class="{{ theme()->printHtmlClasses('footer-container', false) }} d-flex flex-column flex-md-row flex-stack">
		...
		<div class="text-dark order-2 order-md-1">
			<span class="text-gray-400 fw-bold me-1">Alle rechten voorbehouden 2022©</span>
			<a href="{{ theme()->getOption('general', 'website') }}" target="_blank" class="text-muted text-hover-primary fw-bold me-2 fs-6">Fremen</a>
		</div>
		<!--end::Copyright-->
