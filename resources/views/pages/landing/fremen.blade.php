                                    ...
                                    <div class="d-flex h-100 align-items-center">
                                        ...
                                        <div class="w-100 d-flex flex-column flex-center rounded-3 bg-body py-15 px-10">
                                            ...
                                            <div class="mb-7 text-center">
                                                ...
                                                <div class="text-center">
                                                    ...
                                                    <span class="fs-3x fw-bolder text-primary"
                                                          data-kt-plan-price-month="99" data-kt-plan-price-annual="999">99</span>
                                            ...
                                            <div class="w-100 mb-10">
                                                ...
                                                <div class="d-flex flex-stack mb-5">
                                                    <span
                                                        class="fw-bold fs-6 text-gray-800">Keen Analytics Platform</span>
                                    ...
                                    <div class="d-flex h-100 align-items-center">
                                        ...
                                        <div
                                            ...
                                            <div class="w-100 mb-10">
                                                ...
                                                <div class="d-flex flex-stack">
                                                    <span
                                                        class="fw-bold fs-6 text-white opacity-75">Unlimited Projects</span>
                                                    <!--begin::Svg Icon | path: icons/duotune/general/gen040.svg-->
                                                    <span class="svg-icon svg-icon-1 svg-icon-white">
															<svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                                 height="24" viewBox="0 0 24 24" fill="none">
